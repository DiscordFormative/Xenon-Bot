...
client.on('ready', () => {
console.log(`${client.user.tag} ${client.guilds.size} Sunucuya Hizmet Veriyor`);
console.log("Status Developer by iBPlus")

client.user.setActivity(`Discord`, {
type: "STREAMING",
url: "https://www.twitch.tv/ibplus01"})
    .then(presence => console.log(`Your Status has been set to Streamer`))
    .catch(console.error);
});
